    ...
    return (
        loading ? <div className="flex h-screen justify-center items-center">
            ...
            <main className="text-center my-4 mx-12 bg-slate-100 p-4 rounded-lg shadow-md md:my-6 md:mx-24 lg:mx-44 lg:my-8">
                <p className="p-5">Article posted successfully!</p>
                <Link to={`/articles/${newArticle.article_id}`} className="p-5 uppercase hover:font-bold">View the Article</Link>
            </main>
        ) : (
            <main className="text-center my-4 mx-12 bg-slate-300 p-4 rounded-lg shadow-md md:my-6 md:mx-24 lg:mx-44 lg:my-8">
                <h2 className="p-5 uppercase">Post New Article</h2>
                <form onSubmit={handleSubmit}>
                    <label>
                        ...
                        <main className="p-2 pt-5">
                            <label className="p-2 pt-5">Topic</label>
                            <select className="" name="topic" id="topic_type" value={topic} onChange={handleTopicChange}>
