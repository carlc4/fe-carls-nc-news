...
function CommentCard({ comment, article_id }) {
  ...
  return error ? <p className="text-center my-4 mx-12 bg-slate-100 p-4 rounded-lg shadow-md md:my-6 md:mx-24 lg:mx-44 lg:my-8">An error has occured, please refresh your page</p> : (
    ...
    <article className="grid grid-cols-6 my-4 mx-12 bg-slate-100 p-4 rounded-lg shadow-md md:my-6 md:mx-24 lg:mx-44 lg:my-8">
      <h5 className="col-span-6"> {comment.body} </h5>

      <h4 className="col-span-2 pb-2 text-sm text-slate-500 hover:text-slate-800 sm:text-md cursor-pointer">by {comment.author}</h4>
