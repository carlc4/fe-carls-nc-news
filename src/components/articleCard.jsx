  ...
  return (
    <>
      <article className="grid grid-cols-6 m-5 bg-white p-4 rounded-lg shadow-md md:m-16 lg:mx-36">
        ...
        <h4 className="col-span-2 align-middle box-border rounded-md font-bold uppercase text-center border-2 border-red-300 sm:text-xl">{article.topic}</h4>

        <h3 className="col-span-4 pb-2 font-bold uppercase text-lg sm:text-xl">{article.title}</h3>
        ...
        <p className="mx-auto col-span-2 p-3 text-slate-500 hover:text-slate-800 text-xs sm:text-md md:text-lg lg:text-lg">{article.comment_count} Comments</p>
        <p className="mx-auto col-span-2 p-3 text-slate-500 hover:text-slate-800 text-xs sm:text-md md:text-lg lg:text-lg">{article.votes} Votes</p>
        <div className="col-span-1"></div>
      </article>
    </>
  );
